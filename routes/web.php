...
Route::post('/documents', 'DocumentController@search');
...
Route::get('/service/exist/taf', 'ServiceController@existInfoUpdateForTAF');
Route::get('/service/exist/rpa', 'ServiceController@existInfoUpdateForRPA');
Route::get('/service/exist/unf', 'ServiceController@existInfoUpdateForUNF');
